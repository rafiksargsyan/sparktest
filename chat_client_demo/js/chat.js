...
var ChatController = (function () {
    ...
    var attachControllerServerSideEventToMessageBox = function (channelId) {
        var client = new EventSource("http://localhost:8081/chat/receive/"+channelId); // TODO: needs to move to a reverse proxy
    ...
    function postPayload(payload, channelId) {
        $.ajax({
                url : "http://localhost:8080/chat/publish/"+channelId+"/" + userId,
                type: "POST",
                data: payload,
